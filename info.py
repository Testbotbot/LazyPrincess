...
BOT_TOKEN = environ['7719610759:AAEiFaJr55YUMpAwedrWglcU1BXpQZFX_-Q']

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))
PICS = (environ.get('PICS', ' https://envs.sh/Rx5.jpg ')).split()
...
auh_grp = environ.get('AUTH_GROUP')
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "MovizTube_Group") #[ without @ ]
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '1700825627').split()]
...
CAPTION_BUTTON_URL = "https://t.me/ultroidofficial"
